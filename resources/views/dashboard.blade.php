<x-layouts.app :title="config('app.name', 'Coach Board')">
    ...
    @else
        <section class="rounded-4xl border border-dashed border-slate-300 bg-white/80 p-6 text-center shadow-lg shadow-emerald-950/5 backdrop-blur">
    ...
    <section class="rounded-4xl border border-white/80 bg-white/85 p-5 shadow-lg shadow-emerald-950/5 backdrop-blur">
        <div class="flex items-center justify-between gap-4">
            ...
            <a href="{{ route('games.index', absolute: false) }}" class="text-sm font-semibold text-emerald-700">See all</a>
        </div>
            ...
            @forelse ($upcomingGames as $game)
                ...
                >
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div class="rounded-2xl bg-amber-100 px-3 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-amber-800">
